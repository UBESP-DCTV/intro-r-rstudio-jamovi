...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://github.com/UBESP-DCTV/intro-r-rstudio-jamovi/raw/master/img/ubep.jpg",
    og_type = "website",
    og_author = "UBEP",
...
- **R internal help** (eg, `?lm`), also accessible from [**rdocumentation.org**](https://www.rdocumentation.org/)

- [**R 4 Data Science**](https://r4ds.had.co.nz/) free book by [**Hadley Wickham**](http://hadley.nz/), and [**Garrett Grolemund**](https://rstudio.com/speakers/garrett-grolemund/)

- [**RStudio primers**](https://rstudio.cloud/learn/primers) (free
  on-line environment to learning data science basics with interactive
  tutorials)

- [**Jamovi** user's guide](https://www.jamovi.org/user-manual.html)

- [**Learning Statistics with JAMOVI**](https://www.learnstatswithjamovi.com/) free book by [**Danielle Navarro**](https://djnavarro.net/), and [David Foxcroft](https://www.davidfoxcroft.com/)
